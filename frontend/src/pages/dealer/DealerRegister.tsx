...
const schema = z.object({
  dealershipName: z.string().trim().min(2, "Dealership name is required").max(100),
          ...
          <form onSubmit={handleSubmit} className="space-y-5" noValidate>
            <div>
              ...
              <div className="relative">
                ...
                <input id="dealershipName" name="dealershipName" value={formData.dealershipName} onChange={handleChange} placeholder="AutoPrime Motors" className={inputClass("dealershipName")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="contactName" name="contactName" value={formData.contactName} onChange={handleChange} placeholder="John Kamau" className={inputClass("contactName")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="email" name="email" type="email" value={formData.email} onChange={handleChange} placeholder="info@autoprime.co.ke" className={inputClass("email")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="+254712345678" className={inputClass("phone")} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="password" name="password" type={showPassword ? "text" : "password"} value={formData.password} onChange={handleChange} placeholder="Create a strong password" className={`${inputClass("password")} !pr-12`} />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-5 w-5 text-muted-foreground" />
                <input id="confirmPassword" name="confirmPassword" type={showPassword ? "text" : "password"} value={formData.confirmPassword} onChange={handleChange} placeholder="Confirm your password" className={inputClass("confirmPassword")} />
              </div>
